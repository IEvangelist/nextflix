  ...
  return (
    <footer className="relative mt-32 border-t border-white/10 bg-black/95">
      ...
      <div className="w-full px-[clamp(1.25rem,4vw,4rem)] py-16">
        ...
        <div className="grid gap-12 md:gap-10 lg:gap-14 [--min:150px] grid-cols-[repeat(auto-fit,minmax(var(--min),1fr))] mb-14">
          {/* Brand + description */}
          <div className="max-w-sm">
            <div className="text-2xl font-bold tracking-tight text-red-600 mb-4">NEXTFLIX</div>
            <p className="text-sm text-gray-400 leading-relaxed mb-5 pr-4">
              A Netflix-inspired demo built with Next.js + TMDB. The majority of footer links are decorative placeholders.
            </p>
            <div className="flex items-center gap-4">
              <a
                ...
                className={"text-gray-400 hover:text-white transition-colors p-2 rounded-full hover:bg-white/10 " + extLinkBase}
        ...
        {/* Bottom bar */}
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row md:items-center gap-6 text-[13px] text-gray-500/80">
          <div className="flex items-center gap-5 flex-wrap">
            <span className="text-white/60">© {currentYear} Nextflix, Inc.</span>
            <span className="hidden md:inline-block w-px h-4 bg-white/15" aria-hidden />
            <span>
              Built by{' '}
              <a
                href="https://davidpine.net"
